...
interface ProfileFormProps {
  profile: Profile;
  existingKycDocument?: KycDocument | null;
}

export function ProfileForm({ profile, existingKycDocument }: ProfileFormProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <KycUploadForm profile={profile} existingDocument={existingKycDocument} />
    </div>
  );
}
